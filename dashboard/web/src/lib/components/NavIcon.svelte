<script lang="ts">
	// 侧栏条目图标(P2.n 收尾):lucide 风格 stroke 线稿,currentColor 跟随
	// 激活/悬停色。name 与 $lib/nav.ts 的 icon 字段对应。
...
>
	...
	{:else if name === 'brain'}
		<path d="M12 4a4 4 0 0 0-4 4 3 3 0 0 0-1 5.8A3.5 3.5 0 0 0 12 20a3.5 3.5 0 0 0 5-6.2A3 3 0 0 0 16 8a4 4 0 0 0-4-4z" /><path d="M12 4v16" />
	{:else if name === 'eye'}
