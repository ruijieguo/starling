...
def rt(tmp_path, monkeypatch):
    ...
    test_basic_retrieve_smoke.py: relax preflight, build a real
    SqliteAdapter-backed Runtime at a tmp path, start it, and restore
    the preflight requirement at teardown.
