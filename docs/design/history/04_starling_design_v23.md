...
> **本版**为 P1 编码起点。文档由主文档（本文件，§0 摘要、§1 公理、§2 总览、§3 数据本体、§14 端到端场景、§15 路线图、§16 取舍与风险）+ 11 个子系统文档（位于 `v23_subsystems/` 目录）组成。历史变更记录见 [附录 H](#附录-h)。
...
```
   ...
   │   - local-store: seekdb + LadybugDB（嵌入式，P1）                   │
   │     · seekdb: 关系 + JSON + 向量 (HNSW+IVF) + BM25 FTS + Hybrid     │
   │       同机 daemon + MySQL wire over unix socket                     │
   │     · LadybugDB: 图（Kuzu 的 MIT fork），C++ in-process              │
...
| # | 子系统 | 文档 | 职责 |
|---|---|---|---|
| 1 | Substrate Adapter | [v23_04_substrate.md](v23_subsystems/v23_04_substrate.md) | 三档 profile 的物理底座抽象，三层隔离 |
| 2 | EngramStore | [v23_06_engramstore.md](v23_subsystems/v23_06_engramstore.md) | verbatim 原档，retention_mode 生命周期 |
| 3 | Hippocampus | [v23_06_hippocampus.md](v23_subsystems/v23_06_hippocampus.md) | 快记忆（VOLATILE）、事件切分、Working Set、Affect Buffer |
| 4 | Neocortex | [v23_07_neocortex.md](v23_subsystems/v23_07_neocortex.md) | 慢记忆（CONSOLIDATED）、holder 子图族、五子区 |

**核心运行时子系统**（7 个）：

| # | 子系统 | 文档 | 职责 |
|---|---|---|---|
| 5 | Statement Bus | [v23_05_bus.md](v23_subsystems/v23_05_bus.md) | 写入入口、Validator、ConflictProbe、事件分发、幂等 |
| 6 | Cognizer Hub | [v23_08_cognizer.md](v23_subsystems/v23_08_cognizer.md) | 主体注册、KnowledgeFrontier、RelationEdge |
| 7 | ToM Engine | [v23_09_tom.md](v23_subsystems/v23_09_tom.md) | 二阶信念追踪、perspective_take、7 Mentalizing Primitives |
| 8 | Replay Scheduler | [v23_10_replay.md](v23_subsystems/v23_10_replay.md) | Online/Idle/Sleep 巩固，自适应遗忘 |
| 9 | Reconsolidation Engine | [v23_11_reconsolidation.md](v23_subsystems/v23_11_reconsolidation.md) | 被回忆即可塑，supersedes 链 |
| 10 | Prospective Loop | [v23_12_prospective.md](v23_subsystems/v23_12_prospective.md) | Trigger + Commitment 5 态 + ActionGuard（含 PolicyEngine 触发引擎） |
| 11 | Retrieval Planner | [v23_13_retrieval.md](v23_subsystems/v23_13_retrieval.md) | 9 Intent + 7 步规划 + Context Pack 8 标签 |

**横切子系统**（1 个）：

| # | 子系统 | 文档 | 职责 |
|---|---|---|---|
| 12 | Runtime Governance | [v23_05_governance.md](v23_subsystems/v23_05_governance.md) | RuntimeHealth 4 态、PipelineRun 账本、ScopedWorkGate 限流 |

**P1 编码必读顺序**：

1. 主文档 §3 数据本体（schema 与边）
2. v23_04_substrate.md（preflight 与索引）
3. v23_05_bus.md（写入路径与事件表）
4. v23_06_engramstore.md（证据底座）
5. v23_06_hippocampus.md（VOLATILE 入口）
6. v23_13_retrieval.md（basic_retrieve P1 闭环）
7. 主文档 §14 端到端场景流程
8. 主文档 §15 路线图（M0.0 到 M0.7）

P2+ 才需要读：v23_05_governance.md、v23_07_neocortex.md（CONSOLIDATED 落地）、v23_08_cognizer.md、v23_09_tom.md、v23_10_replay.md、v23_11_reconsolidation.md、v23_12_prospective.md。
...
- **P3 Projection Index**：7 类专用投影（idx_holder_state_time / idx_holder_subgraph / idx_entity_statement / idx_salience_hot / idx_commitment_due / idx_common_ground / idx_vector_payload），由 outbox subscriber 异步物化，详见 v23_04_substrate.md。
...
class Commitment(Statement):
    ...
    trigger: Trigger                       # 触发规约，见 v23_12_prospective.md
...
12 CRITICAL 用例为 P1 出货门槛，缺一不可。详细列表见 v23_subsystems/07_v16_eng_review_test_plan.md。
