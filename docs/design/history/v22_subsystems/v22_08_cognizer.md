...
完整 `perspective_take` 算子见 [perspective_take](v22_09_tom.md)。
...
`persona` 字段的容器语义见 [Persona Container](v22_07_neocortex.md)。
...
| **Persona Container** | Cognizer 长期画像，慢通道更新；见 [Persona Container](v22_07_neocortex.md) |
| **perspective_take** | ToM Engine 视角切换算子，调用 KnowledgeFrontier 做硬过滤；见 [perspective_take](v22_09_tom.md) |
