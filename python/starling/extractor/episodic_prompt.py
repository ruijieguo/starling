...
Each event: {"actor": str, "actor_kind": "cognizer"|"entity", "action": str, "theme": str, "location": str|null, "participants": [str], "time": str|null}
...
- actor = the entity performing the action. actor_kind = "cognizer" when the actor is a person / AI agent / team (the usual case), or "entity" when a non-cognizer performs the action ("the script ran", "the cron job fired", "the build failed"). A cognizer is anything that can hold beliefs; a script/process/device is "entity".
...
- participants = ONLY the cognizers NAMED in THAT event. Do NOT infer who else is present, watching, or in the room. If the event names one person, participants has exactly that one person. If a clause has a conjoined subject ("X and Y …") or a plural pronoun referring to people named earlier ("they …" / "them"), RESOLVE it to the individual names: list each person in participants (e.g. ["Xiao Li", "Youyou"]) and pick one named individual as the actor — NEVER emit a single "X and Y" string, or a bare "they", as a person. participants holds ONLY cognizers (people / AI agents / named teams). NEVER put a product, library, device, tool, metric, or file into participants — those are theme/location, not participants. If a "tell"/"inform" event's recipient is a system or document rather than a person, leave it out of participants.
...
JSON array:
[
  {"actor":"Sally","actor_kind":"cognizer","action":"put","theme":"ball","location":"basket","participants":["Sally"],"time":null},
  {"actor":"Sally","actor_kind":"cognizer","action":"leave","theme":"room","location":null,"participants":["Sally"],"time":null},
  {"actor":"Anne","actor_kind":"cognizer","action":"move","theme":"ball","location":"box","participants":["Anne"],"time":null}
]
...
JSON array:
[
  {"actor":"Tom","actor_kind":"cognizer","action":"take","theme":"keys","location":null,"participants":["Tom"],"time":"9am"},
  {"actor":"Tom","actor_kind":"cognizer","action":"leave","theme":"office","location":null,"participants":["Tom"],"time":null},
  {"actor":"Mary","actor_kind":"cognizer","action":"return","theme":"office","location":null,"participants":["Mary"],"time":null},
  {"actor":"Mary","actor_kind":"cognizer","action":"place","theme":"letter","location":"desk","participants":["Mary"],"time":null}
]
...
JSON array:
[
  {"actor":"Sally","actor_kind":"cognizer","action":"tell","theme":"ball","location":"box","participants":["Sally","Anne"],"time":null}
]
...
JSON array:
[
  {"actor":"Anne","actor_kind":"cognizer","action":"see","theme":"Smarties tube","location":"Smarties","participants":["Anne"],"time":null},
  {"actor":"Tom","actor_kind":"cognizer","action":"open","theme":"Smarties tube","location":"pencils","participants":["Tom"],"time":null}
]
...
JSON array:
[
  {"actor":"Xiao Li","actor_kind":"cognizer","action":"find","theme":"hat","location":"suitcase","participants":["Xiao Li","Youyou"],"time":null},
  {"actor":"Youyou","actor_kind":"cognizer","action":"leave","theme":"basement","location":null,"participants":["Youyou"],"time":null},
  {"actor":"Xiao Li","actor_kind":"cognizer","action":"move","theme":"hat","location":"storage locker","participants":["Xiao Li"],"time":null}
]
...
JSON array:
[
  {"actor":"Noah","actor_kind":"cognizer","action":"enter","theme":"hall","location":null,"participants":["Noah","Emma","Liam"],"time":null},
  {"actor":"Noah","actor_kind":"cognizer","action":"find","theme":"watermelon","location":"green_bucket","participants":[],"time":null},
  {"actor":"Noah","actor_kind":"cognizer","action":"leave","theme":"hall","location":null,"participants":["Noah"],"time":null},
  {"actor":"Emma","actor_kind":"cognizer","action":"move","theme":"watermelon","location":"blue_chest","participants":["Emma"],"time":null}
]
